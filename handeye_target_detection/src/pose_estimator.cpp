...
void tf2::transformTF2ToMsg(const tf2::Transform& tf2, geometry_msgs::msg::TransformStamped& msg,
                       ...
                       const std::string& child_frame_id)
{
    ...
    // Extract translation from tf2 transform
    ...
    // Extract rotation from tf2 transform and assign to msg
